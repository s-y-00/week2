...
it('[assignment] iii. see assignment doc for details', async () => {
      ...
      const bobWithdrawUtxo = new Utxo({ amount: bobReceiveUtxo.amount.sub(bobWithdrawAmount), keypair: bobKeypair })
      await transaction({
        tornadoPool,
      ...
      // Alice withdraws all her remaining funds from the shielded pool
